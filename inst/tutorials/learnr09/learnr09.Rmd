...
<div id="predict-hint">
**Hint:** The `predict()` function might be helpful for this task. Make sure you only set continuous variables to their mean. Categorical/dummy variables should be set to their median value.
</div>
